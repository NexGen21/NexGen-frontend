...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch('https://nexgendesignsbackend.vercel.app/api/contact', {
      method: 'POST',
      headers: {
              ...
              <div class="md:grid grid-cols-2 gap-x-2 gap-y-8 w-[80%] mx-auto">
                ...
                <div class="md:w-[60%]">
                  ...
                  <div className='flex md:justify-end pr-4 w-full mt-6'>
                    <button className='scale rounded-xl hover:border-2 text-white p-3 text-xl textgrad3 mr-8' onClick={handleReset}>Reset</button>
